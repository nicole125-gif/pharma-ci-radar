...
import { BookOpen, ClipboardCheck, LayoutDashboard, Search, ShieldCheck } from "lucide-react";
...
const items = [
  ...
  { view: "evidence", href: "/knowledge?view=evidence", label: "证据 QA", icon: ShieldCheck }
];
