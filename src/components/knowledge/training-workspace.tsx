  ...
  return (
    <div className="grid grid-cols-[260px_1fr] gap-5 max-[900px]:grid-cols-1">
      ...
      <div className="grid gap-5">
        {!selectedLearner && <div className="panel p-6 text-sm text-[var(--muted)]">选择或创建学习者后开始记录训练。</div>}
        {selectedLearner && weeks.map((week) => (
